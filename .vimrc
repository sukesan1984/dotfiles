...
"Plugin 'jslint.vim'
Plugin 'ref.vim'
"Plugin 'git://github.com/vim-scripts/errormarker.vim.git'
Plugin 'git://github.com/mattn/gist-vim.git'
Plugin 'git://github.com/mattn/webapi-vim.git'
Plugin 'git://github.com/vim-scripts/yaml.vim.git'
Plugin 'git://github.com/tpope/vim-markdown.git'
Plugin 'git://github.com/mattn/mkdpreview-vim.git'
Plugin 'git://github.com/nanotech/jellybeans.vim.git'
Plugin 'buftabs'
Plugin 'vim-coffee-script'
Plugin 'https://github.com/pekepeke/titanium-vim.git'
"Plugin 'fugitive.vim'
"Plugin 'migrs/qfixhowm'
